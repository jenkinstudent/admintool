...
@NgModule({
  ...
  exports: [GreetPipe,BreadcrumbsComponent,ModuleDetailsComponent,SidebarComponent,ScrollspyDirective,FilterPipe,FirstletterPipe,ProgramPipe,CoursePipe,ModulePipe,
  ProgramCoursePipe,ProgramModulePipe,YoutubePipePipe,CourseModulePipe]
})
