  ...
  */
  ...
  getItems(ev: any) {
    ...
    this.dataService.getMyProgramsData().subscribe(data=>{
      this.searchProgram = data.data.filter((obj:any) => (obj.programId?.title.toLowerCase().indexOf(this.val.toLowerCase()) > -1 || obj.programId?.keywords.toLowerCase().indexOf(this.val.toLowerCase()) > -1));
    })
    this.dataService.getMyLearningActivityData().subscribe(data=>{
      this.searchLearningActivity = data.data.filter((obj:any) => (obj.programId?.title.toLowerCase().indexOf(this.val.toLowerCase()) > -1 || obj.programId?.keywords.toLowerCase().indexOf(this.val.toLowerCase()) > -1));
    })
    this.dataService.getMyCoursesData().subscribe(data=>{
      this.searchCourse = data.data.filter((obj:any) => (obj.courseId?.title.toLowerCase().indexOf(this.val.toLowerCase()) > -1 || obj.courseId?.keywords.toLowerCase().indexOf(this.val.toLowerCase()) > -1));
    })
    this.dataService.getMyModulesData().subscribe(data=>{
      this.searchModule = data.data.filter((obj:any) => (obj.moduleId?.title.toLowerCase().indexOf(this.val.toLowerCase()) > -1 || obj.moduleId?.keywords.toLowerCase().indexOf(this.val.toLowerCase()) > -1));
    })
