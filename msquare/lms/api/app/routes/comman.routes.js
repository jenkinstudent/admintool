...
module.exports = function(app) {
  ...
  app.get("/api/delete-modWatch-id/:id",controller.deleteModuleAllocation);
  app.get("/api/delete-prgWatch-id/:id",controller.deleteProgramAllocation);
  app.get("/api/delete-courWatch-id/:id",controller.deleteCourseAllocation);
  app.get("/api/delete-laWatch-id/:id",controller.deleteLearningActivityAllocation);
