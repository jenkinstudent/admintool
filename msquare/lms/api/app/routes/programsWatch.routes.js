...
//   app.get("/api/modulewatches-emp-module/:id1/:id2", [authJwt.verifyToken],controller.getModuleWatchesByEmpAndModule);
  ...
  app.post("/api/courseswatch", [authJwt.verifyToken],courseController.get);
  ...
  app.post("/api/moduleswatch", [authJwt.verifyToken],moduleController.get);
  app.post("/api/moduleswatch-statedept", [authJwt.verifyToken],moduleController.getByStateAndDept);
