...
import { l1AdminMENU, l2AdminMENU, l1FinanceMENU, l2FinanceMENU, fieldAdminMENU, businessMENU, branchMENU, superAdminMENU } from './menu';
...
export class HorizontalTopbarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    switch(this.auth.currentUserValue.designation.id){
      case 'L1-Admin':
        this.menuItems = l1AdminMENU;
        break;
      case 'Business':
        this.menuItems = businessMENU;
        break;
      case 'L2-Admin':
        this.menuItems = l2AdminMENU;
        break;
      case 'L1-Finance':
        this.menuItems = l1FinanceMENU;
        break;
      case 'L2-Finance':
        this.menuItems = l2FinanceMENU;
        break;
      case 'Field-Admin':
        this.menuItems = fieldAdminMENU;
        break;
      case 'Branch':
        this.menuItems = branchMENU;
        break;
      case 'Superadmin':
        this.menuItems = superAdminMENU;
        break;
      default:
        this.menuItems = branchMENU;
    }
